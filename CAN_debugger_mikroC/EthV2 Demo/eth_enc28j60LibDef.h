...
extern  void            Spi_Ethernet_putBytes(unsigned char *ptr, unsigned char n);
extern  void            Spi_Ethernet_putConstBytes(const unsigned char *ptr, unsigned char n);
extern  unsigned char   Spi_Ethernet_getByte();
extern  void            Spi_Ethernet_getBytes(unsigned char *ptr, unsigned int addr, unsigned char n);
...
extern  unsigned int    Spi_Ethernet_userTCP(unsigned char *remoteHost, unsigned int remotePort, unsigned int localPort, unsigned int reqLength);
